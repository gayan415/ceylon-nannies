        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-ocean-400 leading-relaxed">
              ...
              west coast, hill country, and south coast. English service. Video check-ins on request.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-ocean-400 mt-3">
              Email:{' '}
              <a href="mailto:ceylonnannies@gmail.com" className="hover:text-white transition-colors">
