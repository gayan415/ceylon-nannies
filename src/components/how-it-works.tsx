export function HowItWorks() {
  const steps = [
    ...
    {
      number: '2',
      title: 'We Match Your Nanny',
      description: 'We confirm your booking and share your nanny\'s details beforehand — and you\'re always welcome to a quick video hello if you\'d like one.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      number: '3',
      title: 'Nanny Arrives',
      description: 'Our nanny arrives at your accommodation. Live camera streaming available on request as an add-on — watch your child anytime from your phone.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
