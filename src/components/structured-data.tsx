...
export function StructuredData() {
  const jsonLd = {
    ...
    '@type': 'LocalBusiness',
    name: 'Ceylon Nannies',
    description: 'Premier English-speaking nanny and babysitter service across Sri Lanka — Colombo, Kandy, Galle, and the south coast. In-hotel and in-villa childcare for traveling families. Video check-ins on request.',
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        { '@type': 'Offer', name: 'Standard Session (4 hours)', price: '59', priceCurrency: 'USD' },
        { '@type': 'Offer', name: 'Full Day Session (8 hours)', price: '99', priceCurrency: 'USD' },
      ],
    },
  }
