...
export const TOWNS: Town[] = [
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before day one, and a quick video hello is always available if you’d like one. She arrives early, follows your routines — bath, milk, stories, lights out — and a video check-in on request lets you see your little one anytime, right from your phone at the table.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We’re a family-founded service — we travel to Sri Lanka every year with our own young children, so we know exactly what it takes to trust someone new in a new country. That’s why we share your nanny’s details before we arrive (with a video hello available if you’d like one), why your nanny follows your routines to the letter, and why a video check-in is always available on request so you can peek in between courses.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before your first session — and a quick video hello is there if you’d like one — so nothing about day one feels like a stranger arriving. She speaks fluent English, follows your routines, and a video check-in on request means you can see your little one from the beach between waves.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We’re founded by travelling parents, so trust is built in: your nanny’s details shared before day one (with a video hello available if you’d like one), a fluent-English, background-verified nanny, and video check-ins on request so you’re never more than a glance away.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Families here often stay poolside — so it’s worth knowing our nanny treats water supervision as her single job whenever children are anywhere near a pool. You’ll meet her on video before the first session, she follows your routines exactly, and a video check-in on request keeps you connected from anywhere in the bay.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Everything about how we work is built for trust: we share your nanny’s details before the first session (a video hello is available if you’d like one), she speaks fluent English and is fully background-verified, and she follows your child’s routines — meals, naps, bedtime — precisely as you set them. Video check-ins on request are there whenever you’d like to see your little one.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Familiar is the key word: we share your nanny’s details before your booking, and a quick video hello is always available if you’d like one, so the first knock on the door is a friendly face, not a stranger. She’s fluent in English, background-verified, follows your routines exactly — and a video check-in on request lets you see your little one from the beach, the spa, or the far end of the sand.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before day one, with a quick video hello available if you’d like one. She speaks fluent English, is fully background-verified, follows your routines exactly, and a video check-in on request lets you see your little one from the park or the pool.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details beforehand, with a quick video hello available if you’d like one, and a video check-in on request lets you see your little one from dinner, an event, or across town.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'As with every booking, we share your nanny’s details ahead of time (a video hello is available if you’d like one), she follows your routines to the letter, and a video check-in on request keeps you connected whenever you step away.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before your booking — with a quick video hello available if you’d like one — so there are no strangers on day one, your routines are followed exactly, and a video check-in on request lets you see your little one from wherever the day takes you.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before your booking — with a quick video hello available if you’d like one — so there are no strangers on day one, your routines are followed exactly, and a video check-in on request lets you see your little one from the trail, the train, or the tea fields.',
