...
export const TOWNS: Town[] = [
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before day one, and a quick video hello is always available if you’d like one. She arrives early, follows your routines — bath, milk, stories, lights out — and optional live camera access lets you check in anytime, right from your phone at the table.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before your first session — and a quick video hello is there if you’d like one — so nothing about day one feels like a stranger arriving. She speaks fluent English, follows your routines, and optional live camera access means you can check in from the beach between waves.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We’re founded by travelling parents, so trust is built in: your nanny’s details shared before day one (with a video hello available if you’d like one), a fluent-English, background-verified nanny, and optional live camera access so you’re never more than a glance away.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Familiar is the key word: we share your nanny’s details before your booking, and a quick video hello is always available if you’d like one, so the first knock on the door is a friendly face, not a stranger. She’s fluent in English, background-verified, follows your routines exactly — and optional live camera access lets you check in from the beach, the spa, or the far end of the sand.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before day one, with a quick video hello available if you’d like one. She speaks fluent English, is fully background-verified, follows your routines exactly, and optional live camera access lets you check in from the park or the pool.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details beforehand, with a quick video hello available if you’d like one, and optional live camera access lets you check in from dinner, an event, or across town.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'As with every booking, we share your nanny’s details ahead of time (a video hello is available if you’d like one), she follows your routines to the letter, and optional live camera access keeps you connected whenever you step away.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before your booking — with a quick video hello available if you’d like one — so there are no strangers on day one, your routines are followed exactly, and optional live camera access lets you check in from wherever the day takes you.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'We share your nanny’s details before your booking — with a quick video hello available if you’d like one — so there are no strangers on day one, your routines are followed exactly, and optional live camera access lets you check in from the trail, the train, or the tea fields.',
